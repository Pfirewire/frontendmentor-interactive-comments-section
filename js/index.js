(() => {
    ...
    const renderComment = (comment, currentUser, isReply) => {
    ...
    const renderCommentsSection = (comments, currentUser) => {
        ...
        for(const comment of comments) {
            renderComment(comment, currentUser, false);
